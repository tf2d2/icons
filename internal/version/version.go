...
const projectURL = "https://github.com/tf2d2/icons"

// GetVersion returns the latest version including runtime GOOS and GOARCH and more.
func GetVersion() string {
	v := goversion.GetVersionInfo(
		goversion.WithAppDetails("tf2d2-icons", "Generate architecture icon details for AWS/Azure/GCP cloud providers", projectURL),
